package DSA;
/**
 * Count_of_number_of_given_string_in_2D_array
 */
public class Count_of_number_of_given_string_in_2D_array {
    ...
    public static int searchString(String needle, int row, int column, String str[], int row_count, int col_count){
        int found =0;
        int r,c;
    ...
    public static int internalSearch(String needle, int row, int col, String hay[], int row_max, int col_max, int xx){
        int found =0;
